                ...
                <div className="flex -space-x-2">
                  {members.slice(0, 6).map((m, i) => (
                    <button
                      ...
                      title={m.name}
                      className={`w-8 h-8 rounded-full border-2 border-white flex items-center justify-center text-xs font-semibold cursor-pointer hover:scale-110 hover:z-10 transition-transform duration-200 ${avatarColors[i % avatarColors.length]}`}
                    >
                      {getInitials(m.name)}
                    </button>
                  ))}
        ...
        <div>
          ...
          {tasks.length === 0 ? (
            <div className="bg-white rounded-xl border border-dashed border-gray-200 py-16 flex flex-col items-center gap-2">
              ...
              <p className="text-xs text-gray-300">Create your first task above</p>
            </div>
          ) : (
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-center justify-center px-4">
          <div className="bg-white rounded-xl shadow-xl p-6 w-full max-w-sm">
            ...
            <h3 className="text-center font-semibold text-gray-800 mb-1">Delete Project?</h3>
